	...
	//Lädt die Berufe und fügt sie in das Dropdown ein
	function SetBerufe(){
	...
	function setKalender(){
		...
		$('.weekchanger').fadeTo("slow", 1);
		$('#kalender_tafel').fadeTo("slow", 1);
	...
	$( "#b_auswahl" ).change(function() {
		if(this.value !== ""){
			SetKlassen();
			$('#klassenauswahl').fadeTo("slow", 1);
			$('.weekchanger').fadeTo("slow", 0);
			$('#kalender_tafel').fadeTo("slow", 0);
		} else {
			$('#klassenauswahl').fadeTo("slow", 0);
			$('.weekchanger').fadeTo("slow", 0);
			$('#kalender_tafel').fadeTo("slow", 0);
		}
	});
